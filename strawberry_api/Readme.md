...
Para acessar a `API`, digite http://localhost:8000/graphql no navegador.
...
> ```
>mutation Pet{
>   addPet(name:"Thor",birthday:"01/04/2020",domain:"dog",gender:"M", breed:"golden retriever", weight: 18.7, microchip:123, photo:"", adoption:"", adoptionInfo:"") {
>    ... on Pet{
>      name
>    }
>    ... on PetExists{
...
> ```
>mutation Pet{
>   addPet(name:"Fluffy",birthday:"07/03/2021",domain:"cat",gender:"F", breed:"Persa", weight: 1.4, microchip:112, photo:"", adoption:"", adoptionInfo:"") {
>    ... on Pet{
>      name
>    }
>    ... on PetExists{
